document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateSidebar = () => {
        ...
        allReports.forEach(r => {
            const cat = r['TIPO DE SERVICIO'] || r.TIPO_DE_SERVICIO || r.categoria || r.CATEGORIA || r.Categoria || 'Sin Categoría';
    ...
    const renderMain = () => {
        ...
        if (currentCategoryFilter !== 'Todas') {
            filtered = allReports.filter(r => {
                const c = r['TIPO DE SERVICIO'] || r.TIPO_DE_SERVICIO || r.categoria || r.CATEGORIA || r.Categoria || 'Sin Categoría';
